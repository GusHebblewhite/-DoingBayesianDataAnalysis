...
#------------------------------------------------------------------------------
#Special Gus Hebblewhite installation function for R packages in jupyter:
install_pkg = function(package){
    install.packages(package, 
                     "C:/Users/Molly/Anaconda3/envs/R/R/library", 
...
if ( any(!have) ) {
    for (each_pkg in want[!have]){
        install_pkg(each_pkg) 
        }
}
